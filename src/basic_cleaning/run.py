...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--input_artifact", 
        type = str,
        help = "Path to the raw input data artifact in W&B",
        required = True
    )
    ...
    parser.add_argument(
        "--output_artifact", 
        type = str,
        help = "The name of the cleaned output artifact to be logged in W&B",
        required = True
    )
    ...
    parser.add_argument(
        "--output_type", 
        type = str,
        help = "The type of the output artifact (e.g., 'dataset')",
        required = True
    )
    ...
    parser.add_argument(
        "--min_price", 
        type = float,
        help = "Minimum price value to filter out outliers",
        required = True
    )
    ...
    parser.add_argument(
        "--max_price",
        type = float,
        help = "Maximum price value to filter out outliers",
        required = True
    )
